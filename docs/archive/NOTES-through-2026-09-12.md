...
[MINIMAP_MINING_REVIEW.md](../MINIMAP_MINING_REVIEW.md) first.
...
Read [MINIMAP_MINING_REVIEW.md](../MINIMAP_MINING_REVIEW.md) before the next
...
[docs/MINIMAP_APPEARANCE_MATCHING.md](../MINIMAP_APPEARANCE_MATCHING.md). It
...
Design follow-up: [minimap appearance matching](../MINIMAP_APPEARANCE_MATCHING.md)
...
Read [docs/PIPELINE_REVIEW.md](../PIPELINE_REVIEW.md) for the current P0-P5
...
[Direct quotation omitted from public archive; see the surrounding dated finding.]
