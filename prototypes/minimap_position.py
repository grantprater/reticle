...
**Counting holes instead of blobs also fails, and predictably.** the read of
...
The identified failure causes, from the read: icons overlapping each other or
...
**The fixed orientation is a SETTING, not a property of the game.** the player set the
