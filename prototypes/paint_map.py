...
Why this exists
---------------
Five times in one session the player looked at a candidate and named a defect in the
...
def main() -> int:
    ...
    def save():
        ...
        out_path.with_suffix(".json").write_text(json.dumps({
            "session_id": sid, "roi": [mx0, my0, mx1, my1], "by": "human",
    ...
    # keys silently did nothing and the player painted the whole mask at one size.
