...
Design, from what the player asked for on 2026-08-27
-------------------------------------------------
...
seeded in on first run.** the call: several agents smoke (Brimstone, Omen,
...
* **never seed the answer file** -- pre-filling rows as done breaks resumption
  ...
  an answer to any row, which is a different thing: it costs the player nothing to
