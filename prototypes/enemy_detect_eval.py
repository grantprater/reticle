...
* **zero top-hat response** (both gun barrels): there is no rim at all. No colour
  or size tuning reaches these. the player identified them only from the minimap,
...
the player reports no such frame came up while labelling. It is a standard strong
