...
the idea, and it supplies something this project almost never gets: a
...
It also doubles as the training/control case the player suggested: the own icon is a
