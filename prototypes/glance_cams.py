...
some other red furniture, because the player never marked that distinction -- that is
...
back VALID, its `cam` answers are worth putting to the player in a labelling pass; if
...
# the mark kinds, mapped onto the answer vocabulary. Only these two are
...
def main(argv=None) -> int:
    ...
    sheet = glance.present(
        ...
        truth_source=f"human, labels/minimap/{a.session}.jsonl (enemy + question marks)",
