...
timer is a fixed 45 s (confirmed by the player), so a plant is a discontinuity in the
...
Two ways in, both better than the clock jump: the player reports a **spike icon at
