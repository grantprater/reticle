...
**NEXT SESSION: get the agent labels, then take the icon work to Lotus and
...
the player named first. It is small and square, far closer to the icon's scale than
